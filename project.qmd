...
### TOP 10 varaicne of unemployment rate state
...
# Calculate variance in unemployment rate for each state
state_variance = (
    merged_data.groupby('State')['Unemployment_Rate']
    .var()
    .reset_index()
    .rename(columns={'Unemployment_Rate': 'Variance'})
)
...
chart = alt.Chart(filtered_data).mark_line(point=True).encode(
    ...
    title='Unemployment Rate Change for Top 10 States with Highest Variance (2014-2024)',
    width=800,
    height=400
)
