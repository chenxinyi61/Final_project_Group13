...
# Filter unemployment data for years 2014-2023
unemployment_filtered = unemployment_rate_race[
    (unemployment_rate_race['Year'] >= 2014) & (unemployment_rate_race['Year'] <= 2023)
]
...
### select one state to see trend and difference
